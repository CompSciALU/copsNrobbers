public class Building {
     ...
     * Directions (0,1,2,3,4) mean (Stay, North, East, sOUTH, West) respectively
    ...
    Boolean moveCharacter (Boolean cop, int direction) {
        ...
        if (direction == 0){
            ...
            if (characterToMove[1] >= ROOMS_LONG - 1) {
        	...
        	if (characterToMove[0] >= ROOMS_WIDE - 1) {
                //if we are on the Eastern edge
                return false;
            }
            else {
                characterToMove[0] += 1;
        	...
        	if (characterToMove[1] <= 0) {
                //if we are on the Southern edge
                return false;
            }
            else {
                characterToMove[1] -= 1;
